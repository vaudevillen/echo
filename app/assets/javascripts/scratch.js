...
function initMap(){
  ...
  {
    current_position = { lat: redirectLat, lng: redirectLng };
  ...
  else if (navigator.geolocation)
  {
    navigator.geolocation.getCurrentPosition(function(position)
    {
      ...
      current_position = chiTown;
  }

  map = new google.maps.Map(document.getElementById('map'), { zoom: 17, center: current_position, zoomControl: true });
